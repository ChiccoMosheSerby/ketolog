...
function buildSteps(isMobile) {
  ...
  return [
    ...
    },
    {
      ...
      tab: 'today',
      emoji: '⚡',
      title: 'תבניות וקיצורים',
      text: 'שכפול ארוחות אתמול בקליק, או הוספת תבנית שמורה — כדי לא להקליד שוב את אותן ארוחות.',
    },
    {
      anchor: 'barcode',
      tab: 'products',
      emoji: '📦',
      title: 'המוצרים שלי + סריקת ברקוד',
      text: 'שומרים כאן מוצרים קבועים לשליפה מהירה. סריקת ברקוד מושכת ערכים תזונתיים אוטומטית, או מזהים מוצר מתמונה.',
    },
    {
      anchor: 'chat',
      tab: 'today',
