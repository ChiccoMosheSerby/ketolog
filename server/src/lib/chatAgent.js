...
- פחמימות נטו = סך הפחמימות, פחות סיבים תזונתיים, פחות אריתריטול, אלולוז ומניטול.
- סטיביה/טרוביה = 0 פחמימות. קסיליטול — ספור כ-60%; מלטיטול/סורביטול/כוהל סוכר לא מזוהה — ספור כמחצית מערכו.
- תוויות: בתווית ישראלית/אירופית שורת הפחמימות כבר בלי סיבים (אל תחסיר שוב, רק רב-כוהליים); בתווית אמריקאית Total Carbohydrates כולל סיבים — החסר אותם. אבל בדוק מאזן מסה: אם שומן+חלבון+פחמימות+סיבים עולים על 100 גרם ל-100 גרם — הפחמימות בפועל כוללות סיבים, והחסר אותם; השווה גם ל-USDA למזון דומה.
